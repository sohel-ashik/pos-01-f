...
import { DateInput, IndividualProductAdder, ReviewCart, SavedCart, SupplierAdder } from "../components/SellAddingComponents";
import { countingAllCart, retrivingLocalAddData } from "../helper/workingWithLocalStorageSell";
...
export default function ProductAdding(){
    ...
    return(
        <ContextSellData.Provider value = {{
            date,setDate,
            ...
            <div className="font-bold text-white bg-maindeep-2 text-center px-5 py-5 fixed left-0 right-0 top-0 z-10">বিক্রয় হিসাব</div>
